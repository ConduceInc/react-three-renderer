...
var MeshDescriptor = function (_Object3DDescriptor) {
  ...
  function MeshDescriptor(react3RendererInstance) {
    _classCallCheck(this, MeshDescriptor);

    var _this = _possibleConstructorReturn(this, (MeshDescriptor.__proto__ || Object.getPrototypeOf(MeshDescriptor)).call(this, react3RendererInstance));
  ...
  _createClass(MeshDescriptor, [{
    ...
    value: function applyInitialProps(threeObject, props) {
      _get(MeshDescriptor.prototype.__proto__ || Object.getPrototypeOf(MeshDescriptor.prototype), 'applyInitialProps', this).call(this, threeObject, props);
      if (threeObject.setDrawMode) {
