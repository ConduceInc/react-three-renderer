...
var _InterleavedBufferGeometryDescriptor = require('./descriptors/Geometry/InterleavedBufferGeometryDescriptor');

var _InterleavedBufferGeometryDescriptor2 = _interopRequireDefault(_InterleavedBufferGeometryDescriptor);

var _InterleavedBufferAttributeDescriptor = require('./descriptors/Geometry/InterleavedBufferAttributeDescriptor');

var _InterleavedBufferAttributeDescriptor2 = _interopRequireDefault(_InterleavedBufferAttributeDescriptor);
...
var _EdgesGeometryDescriptor = require('./descriptors/Geometry/EdgesGeometryDescriptor');
...
var ElementDescriptorContainer = function ElementDescriptorContainer(react3RendererInstance) {
  ...
  this.descriptors = {
    ...
    interleavedBufferGeometry: new _InterleavedBufferGeometryDescriptor2.default(react3RendererInstance),
    interleavedBufferAttribute: new _InterleavedBufferAttributeDescriptor2.default(react3RendererInstance),
